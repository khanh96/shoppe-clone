  ...
  return (
    <ul className='my-3'>
      {Array(5)
        .fill(0)
        .map((_, index) => {
          const isActiveStar = 5 - index === Number(queryConfig.rating_filter)
          return (
            <li className='' key={index}>
              <div
                className={classNames('inline-flex items-center rounded-xl px-3 py-1', {
                  'bg-gray-400/20': isActiveStar
                })}
