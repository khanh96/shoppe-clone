          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                ...
                {...register('name')}
              />
              <button type='submit' className='flex-shrink-0 rounded-sm bg-orange px-6 py-2 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
            ...
            <Popover
              ...
              renderPopover={
                <div className='show-md relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm'>
                  ...
                  <div className='mb-4'>
                    <div className='mt-3 flex px-2 hover:bg-gray-100'>
                      ...
                      <div className='ml-2 flex-grow overflow-hidden'>
                        <div className='truncate'>
                          Gối Niu Ru9 Công Nghệ Đột Phá Graphene Foam, Giúp Nâng Đỡ Đốt Sống Cổ, Chống Đau Vai Gáy
                          -40x60 cm
                        </div>
                      </div>
                      <div className='ml-2 flex-shrink-0'>
                        <span className='text-orange'>₫855.000</span>
                      </div>
                    </div>
                    <div className='mt-3 flex px-2 hover:bg-gray-100'>
                      <div className='flex-shrink-0'>
