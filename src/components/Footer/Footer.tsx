      ...
      <div className='mx-auto max-w-7xl px-4'>
        ...
        <div className='mx-auto my-10 max-w-4xl text-xs'>
          <div className='grid grid-cols-4 gap-4 lg:grid-cols-4'>
            <p className='lg:col-span-1'>CHÍNH SÁCH BẢO MẬT</p>
            <p className='lg:col-span-1'>QUY CHẾ HOẠT ĐỘNG</p>
            <p className='lg:col-span-1'>CHÍNH SÁCH VẬN CHUYỂN</p>
            <p className='lg:col-span-1'>CHÍNH SÁCH TRẢ HÀNG VÀ HOÀN TIỀN</p>
          </div>
        </div>
