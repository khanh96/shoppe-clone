...
export default function NavHeader() {
  ...
  const onChangeLanguage = (language: 'en' | 'vi') => {
        ...
        renderPopover={
          <div className='relative w-56 rounded-sm border border-gray-200 bg-white shadow-md'>
            <div className='flex flex-col px-3 py-2 text-left'>
              <button className='py-2 pl-1 text-left hover:text-orange' onClick={() => onChangeLanguage('vi')}>
                {locales.vi}
              </button>
              <button className='py-2 pl-1 text-left hover:text-orange' onClick={() => onChangeLanguage('en')}>
                {locales.en}
              </button>
            </div>
          </div>
